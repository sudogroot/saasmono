  ...
  const features = [
    {
      ...
      benefits: ["تصنيف القضايا حسب النوع والحالة", "ربط القضايا بالموكلين والمستندات", "متابعة تطورات القضية بسهولة"],
    },
    {
      icon: Calendar,
      title: "جدولة الجلسات",
    ...
    },
    {
      ...
      description: "احفظ معلومات موكليك والخصوم مع سجل كامل للتعاملات والمراسلات",
      benefits: ["قاعدة بيانات شاملة للموكلين", "سجل كامل للتواصل", "إدارة المستندات الخاصة"],
    },
    {
      icon: FileText,
