...
interface GlobalSheetState {
  ...
  // Sheet utilities
  getCurrentSheet: () => GlobalSheetData | null;
  canGoBack: () => boolean;
...
export const SHEET_COMPONENTS = {
  CaseDetails: () =>
    import('../components/cases/case-details-sheet').then(m => ({ default: m.CaseDetails })),
  CaseForm: () => import('../components/cases/case-form').then(m => ({ default: m.CaseForm })),
  ClientDetails: () =>
    import('../components/clients/client-details-sheet').then(m => ({ default: m.ClientDetails })),
  ClientForm: () =>
    import('../components/clients/client-form').then(m => ({ default: m.ClientForm })),
  OpponentDetails: () =>
    import('../components/opponents/opponent-details-sheet').then(m => ({
      default: m.OpponentDetails,
    })),
  OpponentForm: () =>
    import('../components/opponents/opponent-form').then(m => ({ default: m.OpponentForm })),
  CustomContent: () =>
    Promise.resolve({ default: ({ content }: { content: ReactNode }) => content as any }),
    ...
    case:
      type === 'details'
        ...
        : mode === 'create'
          ...
          : 'تعديل القضية',
    client:
      type === 'details' ? 'تفاصيل العميل' : mode === 'create' ? 'إضافة عميل جديد' : 'تعديل العميل',
    opponent:
      type === 'details' ? 'تفاصيل الخصم' : mode === 'create' ? 'إضافة خصم جديد' : 'تعديل الخصم',
  };
